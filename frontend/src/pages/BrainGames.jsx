...
function BrainGames() {
  return (
    <>
      <NavbarLeft />
      <NavbarTop />
      <div className="min-h-screen bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 py-8 px-8 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="hidden md:grid grid-cols-5 gap-6 mb-12">
            {games.map((game, idx) => (
              <a
                ...
                className="group relative rounded-2xl overflow-hidden shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl bg-white"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <span className="text-white font-bold text-lg px-6 py-2 bg-purple-600 rounded-full shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Play Now
                  </span>
                </div>
                <div className="p-3 bg-gray-900">
                  <h2 className="text-center text-sm font-semibold text-white truncate">
                    {game.name}
                  </h2>
                </div>
              </a>
          ...
          <div className="md:hidden grid grid-cols-2 gap-4 mb-12">
            {games.map((game, idx) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative rounded-2xl overflow-hidden shadow-xl transform transition-all duration-300 hover:scale-105 bg-white"
              >
                <div className="overflow-hidden">
                  <img
                    src={game.image}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <span className="text-white font-bold text-sm px-4 py-2 bg-purple-600 rounded-full shadow-lg">
                    Play Now
                  </span>
                </div>
                <div className="p-2 bg-gray-900">
                  <h2 className="text-center text-xs font-semibold text-white truncate">
                    {game.name}
                  </h2>
                </div>
              </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative block w-full rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-[1.02] bg-white"
          >
            <div className="overflow-hidden">
              <img
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
              <span className="text-white text-3xl font-bold px-8 py-4 bg-purple-600 rounded-full shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                Explore More Games
              </span>
            </div>
          </a>
